...
namespace UnitTestProject2
{
    ...
    public class UnitTestT13
    {
        ...
        public void T13_good_need_to_store_payment()
        {
            ...
            //  COIN_LOAD([0] 0; 5, 10):
            int coinKindIndex = 0;
            List<Coin> coins = new List<Coin> { new Coin(5), new Coin(5), new Coin(5), new Coin(5), new Coin(5),
                                                new Coin(5), new Coin(5), new Coin(5), new Coin(5), new Coin(5)};
            vm.CoinRacks[coinKindIndex].LoadCoins(coins);

            // COIN_LOAD([0] 1; 10, 10):
            coinKindIndex = 1;
            coins = new List<Coin> { new Coin(10), new Coin(10), new Coin(10), new Coin(10), new Coin(10),
                                     new Coin(10), new Coin(10), new Coin(10), new Coin(10), new Coin(10)};
            vm.CoinRacks[coinKindIndex].LoadCoins(coins);

            //  COIN_LOAD([0] 2; 25, 10):
            coinKindIndex = 2;
            coins = new List<Coin> { new Coin(25), new Coin(25), new Coin(25), new Coin(25), new Coin(25),
                                    new Coin(25), new Coin(25), new Coin(25), new Coin(25), new Coin(25)};
            vm.CoinRacks[coinKindIndex].LoadCoins(coins);

            //  COIN_LOAD([0] 3; 100, 10):
            coinKindIndex = 3;
            coins = new List<Coin> { new Coin(100), new Coin(100), new Coin(100), new Coin(100), new Coin(100),
            ...
            List<IDeliverable> expectedItemsAsList = new List<IDeliverable> { new PopCan("stuff") };
            ...
            List<Coin> expectedCoinsInStorageBin = new List<Coin>{ new Coin(25), new Coin(100), new Coin(10) };
            ...
            List<Coin> expectedCoinRack0 = new List<Coin> { new Coin(5), new Coin(5), new Coin(5), new Coin(5), new Coin(5) ,
                                                            new Coin(5), new Coin(5), new Coin(5), new Coin(5), new Coin(5) };
            List<Coin> expectedCoinRack1 = new List<Coin> { new Coin(10), new Coin(10), new Coin(10), new Coin(10), new Coin(10),
                                                            new Coin(10), new Coin(10), new Coin(10), new Coin(10), new Coin(10)};
            List<Coin> expectedCoinRack2 = new List<Coin> { new Coin(25), new Coin(25), new Coin(25), new Coin(25), new Coin(25),
                                                            new Coin(25), new Coin(25), new Coin(25), new Coin(25), new Coin(25)};
            List<Coin> expectedCoinRack3 = new List<Coin> { new Coin(100), new Coin(100), new Coin(100), new Coin(100), new Coin(100),
                                                            new Coin(100), new Coin(100), new Coin(100), new Coin(100), new Coin(100)};
