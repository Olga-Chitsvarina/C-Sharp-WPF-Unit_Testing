...
namespace UnitTestProject2
{
    ...
    public class UnitTest7
    {
        ...
        public void T07_good_changing_configuration()
        {
            ...
            //  POP_LOAD([0] 0; "A", 1):
            int popKindIndex = 0;
            List<PopCan> pops = new List<PopCan> { new PopCan("A") };
            ...
            expectedItemsAsList = new List<IDeliverable> { new PopCan("A"), new Coin(25), new Coin(25) };
            ...
            List<Coin> expectedCoinRack0 = new List<Coin> { new Coin(5) };
            List<Coin> expectedCoinRack1 = new List<Coin> { new Coin(10) };
            ...
            List<PopCan> expectedPopRack1 = new List<PopCan> { new PopCan("B") };
            List<PopCan> expectedPopRack2 = new List<PopCan> { new PopCan("C") };
            ...
            // Create some lists in order to add them to CoinsInCoinRacks of the expected one: 
            expectedCoinRack0 = new List<Coin> { new Coin(5) };
            expectedCoinRack1 = new List<Coin> { new Coin(10) };
            expectedCoinRack2 = new List<Coin> { };
            expectedCoinRack3 = new List<Coin> { new Coin(100), new Coin(100), new Coin(100) };
