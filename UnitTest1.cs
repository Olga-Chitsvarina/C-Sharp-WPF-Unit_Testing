...
namespace UnitTestProject
{
    ...
    public class UnitTest1
    {
        ...
        public void T01_good_insert_and_press_exact_change()                
        {
            ...
            List<IDeliverable> expectedItemsAsList = new List<IDeliverable> { new PopCan("Coke") };
            ...
            List<Coin> expectedCoinRack2 = new List<Coin> { new Coin(25), new Coin(25), new Coin(25), new Coin(25) };
            List<Coin> expectedCoinRack3 = new List<Coin> { new Coin(100), new Coin(100) };
